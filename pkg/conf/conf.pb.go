...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x05, 0x64, 0x65, 0x62, 0x75, 0x67, 0x22, 0x97, 0x01, 0x0a, 0x09, 0x44, 0x61, 0x74,
	0x61, 0x62, 0x61, 0x73, 0x65, 0x73, 0x12, 0x3c, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61,
	0x73, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x63, 0x6f, 0x6e, 0x66,
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x73, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x62,
	0x61, 0x73, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x09, 0x64, 0x61, 0x74, 0x61, 0x62,
	0x61, 0x73, 0x65, 0x73, 0x1a, 0x4c, 0x0a, 0x0e, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x87, 0x01, 0x0a, 0x08, 0x53, 0x65, 0x63,
	...
	0x74, 0x79, 0x2e, 0x4a, 0x77, 0x74, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x1a, 0x55, 0x0a, 0x03, 0x4a,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Security)(nil),            // 6: conf.Security
	(*Server_HTTP)(nil),         // 7: conf.Server.HTTP
	(*Server_GRPC)(nil),         // 8: conf.Server.GRPC
	(*Server_HTTP_Cors)(nil),    // 9: conf.Server.HTTP.Cors
	nil,                         // 10: conf.Services.ServicesEntry
	nil,                         // 11: conf.Services.ServersEntry
	nil,                         // 12: conf.Databases.DatabasesEntry
	(*Security_Jwt)(nil),        // 13: conf.Security.Jwt
	(*durationpb.Duration)(nil), // 14: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	7,  // 0: conf.Server.http:type_name -> conf.Server.HTTP
	8,  // 1: conf.Server.grpc:type_name -> conf.Server.GRPC
	10, // 2: conf.Services.services:type_name -> conf.Services.ServicesEntry
	11, // 3: conf.Services.servers:type_name -> conf.Services.ServersEntry
	12, // 4: conf.Databases.databases:type_name -> conf.Databases.DatabasesEntry
	14, // 5: conf.Redis.read_timeout:type_name -> google.protobuf.Duration
	14, // 6: conf.Redis.write_timeout:type_name -> google.protobuf.Duration
	13, // 7: conf.Security.jwt:type_name -> conf.Security.Jwt
	14, // 8: conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	9,  // 9: conf.Server.HTTP.cors:type_name -> conf.Server.HTTP.Cors
	14, // 10: conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	1,  // 11: conf.Services.ServicesEntry.value:type_name -> conf.Service
	0,  // 12: conf.Services.ServersEntry.value:type_name -> conf.Server
	3,  // 13: conf.Databases.DatabasesEntry.value:type_name -> conf.Database
	14, // 14: conf.Security.Jwt.expire_in:type_name -> google.protobuf.Duration
