...
type Database struct {
	...
	TablePrefix *wrappers.StringValue `protobuf:"bytes,4,opt,name=table_prefix,json=tablePrefix,proto3,oneof" json:"table_prefix,omitempty"`
}
...
func (x *Database) GetTablePrefix() *wrappers.StringValue {
	if x != nil {
...
type Cookie struct {
	...
	Name     *wrappers.StringValue `protobuf:"bytes,10,opt,name=name,proto3,oneof" json:"name,omitempty"`
	MaxAge   *wrappers.Int32Value  `protobuf:"bytes,11,opt,name=max_age,json=maxAge,proto3,oneof" json:"max_age,omitempty"`
	Domain   *wrappers.StringValue `protobuf:"bytes,12,opt,name=domain,proto3,oneof" json:"domain,omitempty"`
	Path     *wrappers.StringValue `protobuf:"bytes,13,opt,name=path,proto3,oneof" json:"path,omitempty"`
	HttpOnly *wrappers.BoolValue   `protobuf:"bytes,14,opt,name=http_only,json=httpOnly,proto3,oneof" json:"http_only,omitempty"`
	Secure   *wrappers.BoolValue   `protobuf:"bytes,15,opt,name=secure,proto3,oneof" json:"secure,omitempty"`
...
func (x *Cookie) GetName() *wrappers.StringValue {
	if x != nil {
		return x.Name
	}
	return nil
...
func (x *Cookie) GetMaxAge() *wrappers.Int32Value {
	if x != nil {
		return x.MaxAge
	}
	return nil
...
func (x *Cookie) GetDomain() *wrappers.StringValue {
	if x != nil {
		return x.Domain
	}
	return nil
...
func (x *Cookie) GetPath() *wrappers.StringValue {
	if x != nil {
		return x.Path
	}
	return nil
...
func (x *Cookie) GetHttpOnly() *wrappers.BoolValue {
	if x != nil {
		return x.HttpOnly
	}
	return nil
...
func (x *Cookie) GetSecure() *wrappers.BoolValue {
	if x != nil {
		return x.Secure
	}
	return nil
...
type Logging struct {
	...
	Zap *_struct.Struct `protobuf:"bytes,100,opt,name=zap,proto3" json:"zap,omitempty"`
}
...
func (x *Logging) GetZap() *_struct.Struct {
	if x != nil {
		return x.Zap
	}
	return nil
...
type AppConfig struct {
	...
	TenantKey       *wrappers.StringValue `protobuf:"bytes,1,opt,name=tenant_key,json=tenantKey,proto3,oneof" json:"tenant_key,omitempty"`
	DomainFormat    *wrappers.StringValue `protobuf:"bytes,2,opt,name=domain_format,json=domainFormat,proto3,oneof" json:"domain_format,omitempty"`
...
func (x *AppConfig) GetTenantKey() *wrappers.StringValue {
	if x != nil {
		return x.TenantKey
	}
	return nil
...
func (x *AppConfig) GetDomainFormat() *wrappers.StringValue {
	if x != nil {
...
type Server_HTTP_Csrf struct {
	...
	RequestHeader  *wrappers.StringValue `protobuf:"bytes,17,opt,name=request_header,json=requestHeader,proto3,oneof" json:"request_header,omitempty"`
	FieldName      *wrappers.StringValue `protobuf:"bytes,18,opt,name=field_name,json=fieldName,proto3,oneof" json:"field_name,omitempty"`
...
func (x *Server_HTTP_Csrf) GetRequestHeader() *wrappers.StringValue {
	if x != nil {
...
func (x *Server_HTTP_Csrf) GetFieldName() *wrappers.StringValue {
	if x != nil {
		return x.FieldName
	}
	return nil
...
type Security_Jwt struct {
	...
	ExpireIn             *duration.Duration `protobuf:"bytes,1,opt,name=expire_in,json=expireIn,proto3" json:"expire_in,omitempty"`
	Secret               string             `protobuf:"bytes,2,opt,name=secret,proto3" json:"secret,omitempty"`
	RefreshTokenExpireIn *duration.Duration `protobuf:"bytes,3,opt,name=refresh_token_expire_in,json=refreshTokenExpireIn,proto3" json:"refresh_token_expire_in,omitempty"`
...
func (x *Security_Jwt) GetExpireIn() *duration.Duration {
	if x != nil {
		return x.ExpireIn
	}
	return nil
...
func (x *Security_Jwt) GetRefreshTokenExpireIn() *duration.Duration {
	if x != nil {
...
type Security_CookieKey struct {
	...
	BlockKey *wrappers.StringValue `protobuf:"bytes,2,opt,name=block_key,json=blockKey,proto3,oneof" json:"block_key,omitempty"`
}
...
func (x *Security_CookieKey) GetBlockKey() *wrappers.StringValue {
	if x != nil {
		return x.BlockKey
	}
	return nil
...
type Email_SMTP struct {
	...
	ConnectTimeout *wrappers.Int32Value  `protobuf:"bytes,7,opt,name=connect_timeout,json=connectTimeout,proto3,oneof" json:"connect_timeout,omitempty"`
	SendTimeout    *wrappers.Int32Value  `protobuf:"bytes,8,opt,name=send_timeout,json=sendTimeout,proto3,oneof" json:"send_timeout,omitempty"`
...
func (x *Email_SMTP) GetConnectTimeout() *wrappers.Int32Value {
	if x != nil {
...
func (x *Email_SMTP) GetSendTimeout() *wrappers.Int32Value {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0xcf, 0x02, 0x0a, 0x09, 0x41, 0x70, 0x70,
	...
	0x08, 0x68, 0x6f, 0x73, 0x74, 0x4c, 0x6f, 0x67, 0x6f, 0x12, 0x35, 0x0a, 0x14, 0x70, 0x68, 0x6f,
	0x6e, 0x65, 0x5f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x6f,
	0x6e, 0x18, 0x64, 0x20, 0x01, 0x28, 0x09, 0x48, 0x02, 0x52, 0x12, 0x70, 0x68, 0x6f, 0x6e, 0x65,
	0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01,
	...
	0x75, 0x6c, 0x74, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x22, 0xae, 0x01, 0x0a, 0x04, 0x44,
