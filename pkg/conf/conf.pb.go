...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0xb3, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18, 0x0a, 0x07,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x5b, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e,
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x22, 0x87, 0x01, 0x0a, 0x08, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69,
	...
	0x4a, 0x77, 0x74, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x1a, 0x55, 0x0a, 0x03, 0x4a, 0x77, 0x74, 0x12,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x42,
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	16, // 9: conf.Security.jwt:type_name -> conf.Security.Jwt
	17, // 10: conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	10, // 11: conf.Server.HTTP.cors:type_name -> conf.Server.HTTP.Cors
	17, // 12: conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	1,  // 13: conf.Services.ServicesEntry.value:type_name -> conf.Service
	0,  // 14: conf.Services.ServersEntry.value:type_name -> conf.Server
	3,  // 15: conf.Endpoints.DatabasesEntry.value:type_name -> conf.Database
	6,  // 16: conf.Endpoints.EventsEntry.value:type_name -> conf.Event
	5,  // 17: conf.Endpoints.RedisEntry.value:type_name -> conf.Redis
	17, // 18: conf.Security.Jwt.expire_in:type_name -> google.protobuf.Duration
