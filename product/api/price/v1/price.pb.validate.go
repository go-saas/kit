...
// Validate checks the field values on UpdatePriceParams with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *UpdatePriceParams) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdatePriceParams with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdatePriceParamsMultiError, or nil if none found.
func (m *UpdatePriceParams) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdatePriceParams) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetCurrencyOptions() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, UpdatePriceParamsValidationError{
						field:  fmt.Sprintf("CurrencyOptions[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return UpdatePriceParamsValidationError{
					field:  fmt.Sprintf("CurrencyOptions[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return UpdatePriceParamsMultiError(errors)
	}

	return nil
}

// UpdatePriceParamsMultiError is an error wrapping multiple validation errors
// returned by UpdatePriceParams.ValidateAll() if the designated constraints
// aren't met.
type UpdatePriceParamsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdatePriceParamsMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdatePriceParamsMultiError) AllErrors() []error { return m }

// UpdatePriceParamsValidationError is the validation error returned by
// UpdatePriceParams.Validate if the designated constraints aren't met.
type UpdatePriceParamsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdatePriceParamsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdatePriceParamsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdatePriceParamsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdatePriceParamsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdatePriceParamsValidationError) ErrorName() string {
	return "UpdatePriceParamsValidationError"
}

// Error satisfies the builtin error interface
func (e UpdatePriceParamsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdatePriceParams.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdatePriceParamsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdatePriceParamsValidationError{}
