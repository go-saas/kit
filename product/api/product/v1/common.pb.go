...
var file_product_api_product_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_product_api_product_v1_common_proto_depIdxs = []int32{
	5, // 0: product.api.product.v1.CampaignRule.extra:type_name -> google.protobuf.Struct
