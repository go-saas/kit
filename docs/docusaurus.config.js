...
const config = {
  title: 'GO-SAAS-KIT',
  tagline: 'documentation of GO-SAAS-KIT',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/go-saas/kit/tree/main/docs',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} GO-SAAS-KIT. Built with Docusaurus.`,
      },
      prism: {
