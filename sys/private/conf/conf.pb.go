...
var file_sys_private_conf_conf_proto_rawDesc = []byte{
	...
	0xe2, 0x04, 0x0a, 0x07, 0x53, 0x79, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x34, 0x0a, 0x06, 0x61,
	...
	0x78, 0x1a, 0xa0, 0x04, 0x0a, 0x06, 0x41, 0x70, 0x69, 0x73, 0x69, 0x78, 0x12, 0x1a, 0x0a, 0x08,
	...
	0x1a, 0x52, 0x0a, 0x0b, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	...
	0x3a, 0x02, 0x38, 0x01, 0x1a, 0x57, 0x0a, 0x10, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x52, 0x75,
...
var file_sys_private_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_sys_private_conf_conf_proto_goTypes = []interface{}{
	...
	(*conf.Data)(nil),       // 6: conf.Data
	(*conf.Security)(nil),   // 7: conf.Security
	(*conf.Services)(nil),   // 8: conf.Services
	(*conf.Logging)(nil),    // 9: conf.Logging
	(*conf.Tracers)(nil),    // 10: conf.Tracers
	(*conf.AppConfig)(nil),  // 11: conf.AppConfig
	(*structpb.Struct)(nil), // 12: google.protobuf.Struct
}
var file_sys_private_conf_conf_proto_depIdxs = []int32{
	6,  // 0: sys.internal.Bootstrap.data:type_name -> conf.Data
	7,  // 1: sys.internal.Bootstrap.security:type_name -> conf.Security
	8,  // 2: sys.internal.Bootstrap.services:type_name -> conf.Services
	9,  // 3: sys.internal.Bootstrap.logging:type_name -> conf.Logging
	10, // 4: sys.internal.Bootstrap.tracing:type_name -> conf.Tracers
	11, // 5: sys.internal.Bootstrap.app:type_name -> conf.AppConfig
	...
	12, // 11: sys.internal.SysConf.Apisix.RoutesEntry.value:type_name -> google.protobuf.Struct
	12, // 12: sys.internal.SysConf.Apisix.GlobalRulesEntry.value:type_name -> google.protobuf.Struct
	12, // 13: sys.internal.SysConf.Apisix.UpstreamsEntry.value:type_name -> google.protobuf.Struct
