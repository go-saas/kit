...
var file_saas_api_tenant_v1_tenant_proto_rawDesc = []byte{
	...
	0x72, 0x2f, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x32, 0x68, 0x0a, 0x15, 0x54, 0x65, 0x6e, 0x61,
	...
	0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74,
	0x22, 0x00, 0x42, 0xaf, 0x01, 0x92, 0x41, 0x7e, 0x12, 0x13, 0x0a, 0x0c, 0x53, 0x61, 0x61, 0x73,
	...
	0x61, 0x72, 0x65, 0x72, 0x12, 0x00, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x2d, 0x73, 0x61, 0x61, 0x73, 0x2f, 0x6b, 0x69, 0x74, 0x2f, 0x73,
	0x61, 0x61, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x2f, 0x76,
...
var file_saas_api_tenant_v1_tenant_proto_depIdxs = []int32{
	...
	10, // 34: saas.api.tenant.v1.TenantService.CreateTenant:output_type -> saas.api.tenant.v1.Tenant
	10, // 35: saas.api.tenant.v1.TenantService.UpdateTenant:output_type -> saas.api.tenant.v1.Tenant
	4,  // 36: saas.api.tenant.v1.TenantService.DeleteTenant:output_type -> saas.api.tenant.v1.DeleteTenantReply
	10, // 37: saas.api.tenant.v1.TenantService.GetTenant:output_type -> saas.api.tenant.v1.Tenant
	13, // 38: saas.api.tenant.v1.TenantService.GetTenantPublic:output_type -> saas.api.tenant.v1.TenantInfo
	9,  // 39: saas.api.tenant.v1.TenantService.ListTenant:output_type -> saas.api.tenant.v1.ListTenantReply
	15, // 40: saas.api.tenant.v1.TenantService.GetCurrentTenant:output_type -> saas.api.tenant.v1.GetCurrentTenantReply
	17, // 41: saas.api.tenant.v1.TenantService.ChangeTenant:output_type -> saas.api.tenant.v1.ChangeTenantReply
	19, // 42: saas.api.tenant.v1.TenantService.UserCreateTenant:output_type -> saas.api.tenant.v1.UserCreateTenantReply
	10, // 43: saas.api.tenant.v1.TenantInternalService.GetTenant:output_type -> saas.api.tenant.v1.Tenant
