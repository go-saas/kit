...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("var _ ", serverName, " = ", "(nil)(*", structName, "")
	...
	g.P("cc ", grpcPackage.Ident(clientName))
	g.P("}")
	g.P()

	g.P("func New", structName, " (cc ", grpcPackage.Ident("clientName"), ") ", serverName, " {")
...
// generateFile generates a _grpc_wrapper.pb.go file containing gRPC service definitions.
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	if len(file.Services) == 0 {
		return nil
	}

	filename := file.GeneratedFilenamePrefix + "_grpc_wrapper.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)
	g.P("// Code generated by protoc-gen-go-grpc-wrapper. DO NOT EDIT.")
	g.P("// versions:")
	g.P("// - protoc-gen-go-grpc-wrapper v", version)
